...
class Dovecot(base.Installer):
    ...
    def get_template_context(self):
        ...
        context.update({
            ...
            "kalabash_2_2_or_greater": "" if self.kalabash_2_2_or_greater else "#",
            "not_kalabash_2_2_or_greater": "" if not self.kalabash_2_2_or_greater else "#"
        })
        return context
    ...
    def post_run(self):
        ...
        # See https://github.com/amonak/kalabash/issues/2570
        utils.exec_cmd("chmod 600 /etc/dovecot/conf.d/10-ssl-keys.try")
        # Add mailboxes user to dovecot group for kalabash mailbox commands.
        # See https://github.com/amonak/kalabash/issues/2157.
