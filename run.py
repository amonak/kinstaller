...
import checks
from kinstaller import compatibility_matrix
from kinstaller import constants
from kinstaller import package
from kinstaller import scripts
from kinstaller import ssl
from kinstaller import system
from kinstaller import utils
...
def restore_disclaimer():
    ...
    utils.printcolor(
        "You are about to restore a previous installation of Kalabash.\n"
...
def main(input_args):
    ...
    parser.add_argument(
        ...
        help="Install latest beta release of Kalabash instead of the stable one")
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        "backup will be saved at ./kalabash_backup/Backup_M_Y_d_H_M "
    ...
    parser.add_argument(
        ...
        help="Restore a previously backup up kalabash instance on a NEW machine. "
    ...
    utils.success("Welcome to Kalabash installer!\n")
    ...
    config.set("kalabash", "install_beta", str(args.beta))
    ...
    if not args.restore:
        ...
        utils.success(
            "Restore complete! You can enjoy Kalabash at https://{} (same credentials as before)"
            .format(config.get("general", "hostname"))
        )
    utils.success(
        "\n"
        "Kalabash is a free software maintained by volunteers.\n"
        "You like the project and want it to be sustainable?\n"
        "Then don't wait anymore and go sponsor it here:\n"
    )
    utils.printcolor(
        "https://github.com/sponsors/kalabash\n",
        utils.YELLOW
    )
    utils.success(
